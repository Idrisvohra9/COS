    ...
    <div class="second">
      <div class="third">
        <div class="form">
          ...
          <p style="margin-top:-40px;margin-bottom: 15px;font-weight:bold;">Make COS your's truly.</p>
          <form class="register was-validated" id="register">
            <div class="group">
              <label for="name"><i><img src="Icons/user-svgrepo-com.svg" height="20" width="20" /></i></label>
              <input type="text" name="name" id="name" placeholder="Your Name" required maxlength="15"/>
              <div class="valid-feedback">Username must be under 15 characters. Should not contain any symbols other than hyphens and underscores.</div>
            </div>
            <div class="group">
              <label for="email"><i><img src="Icons/email-svgrepo-com.svg" height="20" width="20" /></i></label>
              <input type="email" name="email" id="email" placeholder="Your Email" required />
            </div>
            <div class="group">
              <label for="pass"><i><img src="Icons/password-svgrepo-com.svg" height="20" width="20" /></i></label>
              <input type="password" name="pass" id="pass" placeholder="Password" required maxlength="6" onkeyup="checkMatch();passStrength();"/>
              <div class="valid-feedback">Password must be 6 digits long and complex.</div>
              <div class="passStrength"><div class="progress">
                <div class="progress-bar"></div>
              </div></div>
              <img src="Icons/visibility-svgrepo-com.svg" alt="" class="pass" onclick="Unhide(this);" />
            </div>
            <div class="group">
              <label for="re-pass"><i><img src="Icons/password-svgrepo-com.svg" height="20" width="20" /></i></label>
              <input type="password" name="re_pass" id="re_pass" placeholder="Repeat your password" required maxlength="6" onkeyup="checkMatch();"/>
              <img src="Icons/visibility-svgrepo-com.svg" alt="" class="pass" onclick="Unhide(this);"/>
            </div>
            <div class="group form-check">
              <input type="checkbox" name="accept" id="accept" class="form-check-input text-bg-dark" style="margin-right: 10px;"/>
              <label for="accept" class="label-accept"> I agree all statements in
		...
		try {
			...
			PreparedStatement stmt = c.prepareStatement("INSERT INTO NewUser(USERNAME,EMAIL,PASS) VALUES(?,?,?)");
