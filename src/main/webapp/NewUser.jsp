	...
	<section class="first">
		<div class="second">
			<div class="third">
				<div class="form">
					...
					<p
						style="margin-top: -40px; margin-bottom: 15px; font-weight: bold;">Make
						COS your's truly.</p>
					<form class="register was-validated" id="register" method="post">
						<div class="group">
							<label for="name"><i><img
									src="Icons/user-svgrepo-com.svg" height="20" width="20" /></i></label> <input
								type="text" name="name" id="name" placeholder="Your Name"
								required maxlength="15" />
							<div class="valid-feedback">Username must be atleast 3 characters and under 15 characters. Should not contain any symbols other than hyphens and underscores.</div>
						</div>
						<div class="group">
							<label for="email"><i><img
									src="Icons/email-svgrepo-com.svg" height="20" width="20" /></i></label> <input
								type="email" name="email" id="email" placeholder="Your Email"
								required />
						</div>
						<div class="group">
							<label for="pass"><i><img
									src="Icons/password-svgrepo-com.svg" height="20" width="20" /></i></label>
							<input type="password" name="pass" id="pass"
								placeholder="Password" required maxlength="6"
								onkeyup="checkMatch();passStrength();" />
							<div class="valid-feedback">Password must be 6 digits long
								and complex.</div>
							...
							<img src="Icons/visibility-svgrepo-com.svg" alt="" class="pass"
								onclick="Unhide(this);" />
						</div>
						<div class="group">
							<label for="re-pass"><i><img
									src="Icons/password-svgrepo-com.svg" height="20" width="20" /></i></label>
							<input type="password" name="re_pass" id="re_pass"
								placeholder="Repeat your password" required maxlength="6"
								onkeyup="checkMatch();" /> <img
								src="Icons/visibility-svgrepo-com.svg" alt="" class="pass"
								onclick="Unhide(this);" />
						</div>
						<div class="group form-check">
							<input type="checkbox" name="accept" id="accept"
								class="form-check-input text-bg-dark"
								style="margin-right: 10px;" /> <label for="accept"
								class="label-accept"> I agree all statements in <a
		...
		try {
			...
			if(Uname!=null && email!=null && pass != null){		
				if(Uname.length() >= 3 && email.length() > 8 && pass.length() <=6){		
				PreparedStatement stmt = c.prepareStatement("INSERT INTO NewUser(USERNAME,EMAIL,PASS) VALUES(?,?,?)");
				stmt.setString(1, Uname);
				stmt.setString(2, email);
				stmt.setString(3, pass);
				
				PreparedStatement stmt2 = c.prepareStatement("INSERT INTO EXISTINGUSER(USERNAME,PASS) VALUES(?,?)");
	...
	<script>
		...
		function Unhide(param) {
			if (n == 0) {
				...
				param.parentElement.children[1]
